...
export type Trip = { id: number; title: string; start_date: string | null; end_date: string | null; country_name: string; city_name: string; budget_amount: number; estimated_transport: number | null; estimated_accommodation: number | null; estimated_food: number | null; estimated_tickets: number | null; estimated_shopping: number | null; estimated_other: number | null; actual_expense: number; actual_transport: number; actual_accommodation: number; actual_food: number; actual_tickets: number; actual_shopping: number; actual_other: number; expense_difference: number; status: TripStatus; notes: string | null; sync_to_important_day: boolean; important_day_id: number | null; items: TripItem[] };
export type TripPayload = { title: string; start_date?: string; end_date?: string; country_name: string; city_name: string; status: TripStatus; notes?: string; collection_item_ids: number[]; budget_amount?: number; estimated_transport?: number; estimated_accommodation?: number; estimated_food?: number; estimated_tickets?: number; estimated_shopping?: number; estimated_other?: number; sync_to_important_day?: boolean; important_day_reminder_days_before?: number; important_day_audience_mode?: "self" | "specific" | "all"; important_day_recipient_ids?: number[]; important_day_show_on_calendar?: boolean };
