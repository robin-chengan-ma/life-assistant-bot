...
| --- | --- | --- | --- | --- |
| 2026-08-17 | `main`／`a6fd474` | GitHub | 完成 | 08/17 Robin 已推版；Render 會自動部署，另需確認 migration 0084 於開機時自動套用成功 |
