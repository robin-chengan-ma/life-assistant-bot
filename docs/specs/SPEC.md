...
**功能性需求**
- FR-73 收藏清單：記錄想去地點或想執行活動；保留名稱、類型、國家、區域／城市、選填地址、參考網址、預估費用與備註，移除優先程度、縣市與想去日期。名稱、類型、國家及區域／城市必填，地址一律明確標示為選填；未填地址仍可建立收藏並以國家及區域／城市執行區域定位。狀態依行程關聯與造訪紀錄自動推導；同一收藏可加入多個行程。收藏支援編輯、刪除、二次確認、5 秒復原與防連點；已有探索歷史時刪除原收藏仍保留歷史快照。
